        ...
        methods: {
            ...
            initMenus() {
                ...
                if (process.env.NODE_ENV == 'development') { // && process.env.NODE_ENV !== 'integration'
                    ...
                    http.get(this.utils.getHost() + "api/interface/permission?menuCode=001002").then(response => {
                        if(response.code == '00000'){
                            this.menus = response.data[0].children;
            ...
            initMatrix() {
               ...
               http.get(this.utils.getHost() + "api/interface/menu").then(response => {
                    if(response.code == '00000'){
